...
SSL_LIBS = -lssl -lcrypto -lrt -lcrypt -lpthread -ldl
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) /home/amiya/softwares/httpd-2.4.3/srclib/apr-util/libaprutil-1.la /home/amiya/softwares/httpd-2.4.3/srclib/apr-util/xml/expat/libexpat.la /home/amiya/softwares/httpd-2.4.3/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
abs_srcdir = /home/amiya/softwares/httpd-2.4.3
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
EXTRA_INCLUDES = -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/include -I/home/amiya/softwares/httpd-2.4.3/srclib/apr/include -I/home/amiya/softwares/httpd-2.4.3/srclib/apr-util/include -I/home/amiya/softwares/httpd-2.4.3/srclib/apr-util/xml/expat/lib -I/usr/local/include -I$(top_srcdir)/modules/aaa -I$(top_srcdir)/modules/cache -I$(top_srcdir)/modules/core -I$(top_srcdir)/modules/database -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/ldap -I$(top_srcdir)/modules/loggers -I$(top_srcdir)/modules/lua -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/modules/session -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/test -I$(top_srcdir)/server -I$(top_srcdir)/modules/arch/unix -I$(top_srcdir)/modules/dav/main -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers
INTERNAL_CPPFLAGS =
LIBTOOL = /home/amiya/softwares/httpd-2.4.3/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
APR_INCLUDEDIR = /home/amiya/softwares/httpd-2.4.3/srclib/apr/include
APR_VERSION = 1.4.6
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/amiya/softwares/httpd-2.4.3/srclib/apr-util/include
APU_VERSION = 1.4.1
